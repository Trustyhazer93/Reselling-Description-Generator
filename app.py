...
def email_free_trial_users():
    ...
    excluded_emails = ["leogentles418@gmail.com","dylxnfrr1502@gmail.com","verrierdylan@icloud.com","joshua_chambers@icloud.com","cockbainsusan@gmail.com","emiliocruzmorrison@gmail.com","andy.bradstock@live.co.uk","mikilovemad123@gmail.com","hcadam12@gmail.com","samueloboyle1705@gmail.com","harryscutt@hotmail.com"]
    users = User.query.filter(User.credits == 10, ~User.email.in_(excluded_emails)).all()
            ...
            if response.status_code in [200, 201]:
                ...
                if retry_response.status_code in [200, 201]:
                    ...
                    failed_emails.append(
                        f"{user.email}: {retry_response.status_code} {retry_response.text}"
                    )
